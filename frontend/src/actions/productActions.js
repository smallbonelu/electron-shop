...
export const deleteProduct = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await fetchClient.delete(`/api/products/${id}`);
    dispatch({
...
export const createProduct = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await fetchClient.post(`/api/products`, {});
    dispatch({
...
export const createProductReview = (productId, review) => async (dispatch) => {
  try {
    ...
    await fetchClient.post(`/api/products/${productId}/reviews`, review);
    dispatch({
